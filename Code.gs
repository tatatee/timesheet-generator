...
var mycal = "your-calendar-email-address@group.calendar.google.com";
...
//
  ...
  var x = thisMonth + " " + firstDay.getDate() + ", " + thisYear + " " + "00:00:00 GMT+8";
  var y = thisMonth + " " + lastDay.getDate() + ", " + thisYear + " " + "23:59:59 GMT+8";

  var events = cal.getEvents(new Date(x), new Date(y));
